...
public class CustomerDaoTest {
	...
	public void testCustomerCreationWithBlankUsername() throws Exception{
		...
		Customer customer = new Customer("", "pin", "austin samuel", "as@gmail.com", "123456", "noida");
	...
	public void testCustomerCreationAlreadyExisting() throws Exception{
		...
		Customer customer = new Customer("austin", "pin", "austin samuel", "as@gmail.com", "123456", "noida");
